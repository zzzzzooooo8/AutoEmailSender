...
export function OtherSettingsCard() {
  ...
  const summary = useMemo(() => {
    ...
    const draftMode = getPreferenceOptionLabel("draft_rewrite_intensity", form.draft_rewrite_intensity) || "默认";
    return `匹配 ${matchConcurrency} / 抓取 ${crawlConcurrency} / 草稿 ${draftMode}`;
  }, [form]);
